...
def compPlayHand(hand, wordList, n):
    ...
    while True:
        ...
        if compWord == None:
            ...
            score += wordScore
            print("'" + compWord + "' earned " + str(wordScore) + " points. Total: " + str(score) + " points")
...
def playGame(wordList):
    ...
    while True:
        ...
        if userInput == 'n':
            ...
            userInput = (raw_input("Enter u to have yourself play, c to have the computer play: ")).lower()
            while userInput != 'c' and userInput != 'u':
            ...
            if len(hand) == 0:
                ...
                userInput = (raw_input("Enter u to have yourself play, c to have the computer play: ")).lower()
            while userInput != 'c' and userInput != 'u' and userInput != r:
                print("Invalid command.")
                userInput = raw_input("Enter u to have yourself play, c to have the computer play: ")
            if userInput == 'u':
                playHand(hand, wordList, HAND_SIZE)
