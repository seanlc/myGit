...
def isValidWord(word, hand, wordList):
    ...
    valid = False
    for letter in word:
        if letter in afterHand.keys():
            afterHand[letter] -= 1
            if afterHand[letter] == 0:
                del afterHand[letter]
            valid = True
            continue
        else:
            valid = False
    ...
    while calculateHandlen(hand) > 0:
        ...
        if userWord == '.':
            ...
            if not isValidWord(userWord, hand, wordList):
                ...
                print(userWord + " earned " + str(getWordScore(userWord, n)) + " points. Total: " + str(score) + " points")
                print("")
